...
const TOKEN_NAME = "DREAM";
const TOKEN_SYMBOL = "DRM💭";
const TOKEN_DESCRIPTION = "A token for Dream Builders";
const TOKEN_IMAGE_NAME = "dream.png"; // Replace unicorn.png with your image name
